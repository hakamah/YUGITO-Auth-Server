        ...
        try:
            ...
            if u.path == "/oauth/callback":
                ...
                if platform == "android":
                    ...
                    # bloque l'ouverture automatique, le bouton reste disponible en secours.
                    return_intent = "intent://auth-complete#Intent;component=com.hakamah.yugitogc/com.godot.game.GodotAppLauncher;end"
                    body = (
                        "<h1>Compte Google lié ✅</h1>"
                        "<p>Retour vers YUGITO…</p>"
                        "<p><a style='display:inline-block;padding:14px 22px;border:1px solid #f3a64c;border-radius:12px;color:#fff;text-decoration:none' href='" + return_intent + "'>REVENIR DANS YUGITO</a></p>"
                        "<script>setTimeout(function(){location.href='" + return_intent + "';},180);</script>"
                    )
                    self._html(200,body); return
